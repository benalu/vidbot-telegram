...
// ✨ IMPORT SPIDER LK21
const { handleSeedMovs, handleSeedMovsStatus, handleInjectMovs, handleInjectMovsCallback } = require('../../../scripts/spider-movs');
...
function registerAdminHandlers(bot) {
  ...
  bot.command('injectmovs', spiderPanelOnly(handleInjectMovs))
  bot.action(/^injectsel:\d+:.+$/, adminOnly(handleInjectMovsCallback))
